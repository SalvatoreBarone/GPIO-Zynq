...
Per lasciare inalterati i registri della periferica il kernel deve disabilitare completamente le interruzioni per la linea di interrupt cui la periferica e' connessa, in modo che il programma userspace possa determinare la causa scatenante l'interruzione. Una volta terminate le operazioni, però, il programma userspace non puo' riabilitare le interruzioni, motivo per cui il driver implementa anche una funzione write(). La funzione write(), chiamata su /dev/uio\+X, consente di riabilitare le interruzioni per quella specifica periferica, scrivendo 1.\hypertarget{uio-int_8c_a05909651fa170a63e98e3f8e13451b7b}{\index{uio-\/int.\+c@{uio-\/int.\+c}!howto@{howto}}
...
Una volta effettuato il mapping, le operazioni preventivate con l'invocazione del programma vengono effettuate dalla funzione \hyperlink{uio-int_8c_a78b676750c5d08c316cad35ec3963c53}{gpio\+\_\+op()}. Si rimanda alla sua documentazione per i dettagli sulle operazioni effettuate().\hypertarget{uio-int_8c_ab6b18eb1bf7bc996599c06dc6dad8f53}{\index{uio-\/int.\+c@{uio-\/int.\+c}!parse\+\_\+args@{parse\+\_\+args}}
